export const i18n = {
  en: {
    settings: {
      ...
      todayWidgetPlacementDescription: "Place the widget at the top or bottom of the DNP",
  ...
  zh: {
    settings: {
      ...
      todayWidgetPlacementDescription: "将小组件放在 DNP 顶部或底部",
  ...
  zhHant: {
    settings: {
      ...
      todayWidgetPlacementDescription: "將小工具放在 DNP 頂部或底部",
