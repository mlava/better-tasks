export const i18n = {
  en: {
    settings: {
      ...
      enableTodayWidgetDescription: "Show the Better Tasks Today widget on your daily note page (inline only for now)",
      ...
      dnpHeading: "DNP heading (optional)",
      ...
      projectAttrDescription: "Label for project attribute (child block)",
      gtdAttr: "GTD status attribute name",
      gtdAttrDescription: "Label for GTD status attribute (child block)",
      waitingAttr: "Waiting-for attribute name",
      waitingAttrDescription: "Label for waiting-for attribute (child block)",
      contextAttr: "Context attribute name",
      contextAttrDescription: "Label for context/tags attribute (child block)",
      priorityAttr: "Priority attribute name",
      priorityAttrDescription: "Label for priority attribute (child block)",
      energyAttr: "Energy attribute name",
      energyAttrDescription: "Label for energy attribute (child block)",
    ...
    prompts: {
      ...
      addContext: { title: "Add Context", message: "Enter contexts (comma separated)", placeholder: "Context" },
  ...
  zh: {
    settings: {
      ...
      enableTodayWidgetDescription: "在每日笔记页显示 Better Tasks 今日小组件（目前仅支持内联）",
      ...
      projectAttr: "项目属性名称",
      projectAttrDescription: "项目属性（子块）的标签",
      gtdAttr: "GTD 状态属性名称",
      gtdAttrDescription: "GTD 状态属性（子块）的标签",
      waitingAttr: "等待对象属性名称",
      waitingAttrDescription: "等待对象属性（子块）的标签",
      contextAttr: "情境属性名称",
      contextAttrDescription: "情境/标签属性（子块）的标签",
      priorityAttr: "优先级属性名称",
      priorityAttrDescription: "优先级属性（子块）的标签",
      energyAttr: "精力属性名称",
      energyAttrDescription: "精力属性（子块）的标签",
    ...
    prompts: {
      ...
      addContext: { title: "添加情境", message: "输入情境（逗号分隔）", placeholder: "情境" },
  ...
  zhHant: {
    settings: {
      ...
      enableTodayWidgetDescription: "在每日筆記頁顯示 Better Tasks 今日小工具（目前僅支援內嵌）",
      ...
      projectAttr: "專案屬性名稱",
      projectAttrDescription: "專案屬性（子區塊）的標籤",
      gtdAttr: "GTD 狀態屬性名稱",
      gtdAttrDescription: "GTD 狀態屬性（子區塊）的標籤",
      waitingAttr: "等待對象屬性名稱",
      waitingAttrDescription: "等待對象屬性（子區塊）的標籤",
      contextAttr: "情境屬性名稱",
      contextAttrDescription: "情境/標籤屬性（子區塊）的標籤",
      priorityAttr: "優先級屬性名稱",
      priorityAttrDescription: "優先級屬性（子區塊）的標籤",
      energyAttr: "精力屬性名稱",
      energyAttrDescription: "精力屬性（子區塊）的標籤",
    ...
    prompts: {
      ...
      addContext: { title: "新增情境", message: "輸入情境（逗號分隔）", placeholder: "情境" },
