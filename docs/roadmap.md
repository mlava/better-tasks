...
Better Tasks is now a **feature-complete, polished v1+ product**.

Recently shipped:
- Saved dashboard views (filters + grouping + search)
- Cross-graph & cross-device persistence (Roam Depot settings)
